...
def dlt_coefs(vandermonde,
    ...
    :param vandermonde: vandermonde matrix. each row contains the monomials x^2 xy y^2 x y 1 of the corresponding point
    :param weights: probability of belonging to the model for each row in the vandermonde matrix.
