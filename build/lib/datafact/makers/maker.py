...
class Maker(ABC):
    ...
    def generate_random_sample(self, plot=True):
        ...
        sample = convert_to_np_struct(inliers,
                                      outliers, Maker.NUM_POINTS_PER_SAMPLE)  # prima c'era convert_to_np_struct_and_shuffle e la transpose era dentro sta funzione, se voglio tornare indietro devo togliere la transpose da convert_to_mat_struct
